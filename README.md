...
| **[Stock Data Analysis Dashboard](https://harshanirathnayake-flax.vercel.app/portfolio.html)** | A dynamic Power BI dashboard comparing Apple (AAPL) and Google (GOOGL) stock performance  from 2005 to 2025 | Power BI | [Repo](https://github.com/Harshani00/PowerBI/tree/Stock-Data-Analysis#) |
| **[Toy Model Performance Analysis Dashboard](https://harshanirathnayake-flax.vercel.app/toy-model.html)** | A dynamic Power BI dashboard to analysis toy models sales over the years and in different countries | Power BI | [Repo](https://github.com/Harshani00/PowerBI/tree/Toy-Model-Perfomacne-Dashboard#) |
