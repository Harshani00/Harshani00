...
| **[Uber Rides Data Dashboard](https://harshanirathnayake-flax.vercel.app/portfolio.html)** | Analyzed 148K+ rows of Uber NCR data in Power BI to uncover cancellation patterns, peak times, and ride efficiency. Created custom DAX metrics for time-of-day bucketing and distance ranges; removed columns with 50% null values and handled nulls via filters. Delivered interactive visualizations for operational insights, optimizing rider-driver experiences with Power Query for data transformation. | Power BI, Power Query, DAX, Calclulated Columns | [Repo](https://github.com/Harshani00/PowerBI.git) |
| **[Stock Data Analysis Dashboard](https://harshanirathnayake-flax.vercel.app/portfolio.html)** | A dynamic Power BI dashboard comparing Apple (AAPL) and Google (GOOGL) stock performance  from 2005 to 2025 | Power BI,,Power Querty, KPI Cards , DAX  | [Repo](https://github.com/Harshani00/PowerBI/tree/Stock-Data-Analysis#) |
| **[Toy Model Performance Analysis Dashboard](https://harshanirathnayake-flax.vercel.app/toy-model.html)** | A dynamic Power BI dashboard to analysis toy models sales over the years and in different countries | Power BI ,Power Querty, KPI Cards , DAX | [Repo](https://github.com/Harshani00/PowerBI/tree/Toy-Model-Perfomacne-Dashboard#) |
